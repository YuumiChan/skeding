	...
	<div class="mb-6">
		...
		<div class="flex items-center gap-3">
			<input
				...
				min="1"
				class="w-32 p-2 rounded-md focus:outline-none focus:ring-2 text-white"
				style="background-color: #434c5e; border: 1px solid #4c566a; focus:ring-color: #d08770;"
			/>
			<button
				on:click={calculate}
				class="text-white px-4 py-2 rounded-md hover:opacity-90 focus:outline-none focus:ring-2 transition-all duration-200 font-medium"
				style="background-color: #d08770; focus:ring-color: #bf616a;"
			>
				Go
			</button>
		</div>
