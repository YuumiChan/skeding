<script>
	...
	function addExampleData() {
		processes = [
			{ pid: 1, burstTime: 6, arrivalTime: 0 },
			{ pid: 2, burstTime: 4, arrivalTime: 1 },
			{ pid: 3, burstTime: 2, arrivalTime: 2 },
			{ pid: 4, burstTime: 8, arrivalTime: 3 },
		];
	}
			...
			<div class="flex justify-between items-center mb-4">
				...
				<div class="flex gap-2">
					<button
						...
						class:opacity-50={processes.length > 0}
						class:cursor-not-allowed={processes.length > 0}
					>
						Load Example
					</button>
